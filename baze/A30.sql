...
ALTER TABLE Igraju ADD CONSTRAINT FK_Igraju_partijaID FOREIGN KEY (partijaID) REFERENCES Partija(partijaID) ON DELETE CASCADE;
ALTER TABLE Rezultat ADD CONSTRAINT FK_Rezultat_partijaID FOREIGN KEY (partijaID) REFERENCES Partija(partijaID) ON DELETE CASCADE;
ALTER TABLE Rezultat ADD CONSTRAINT FK_Rezultat_rupaID FOREIGN KEY (rupaID) REFERENCES Rupa(rupaID) ON DELETE CASCADE;
